...
請分析這張貨架圖片，並偵測是否含有「豐力富即溶濃縮乳清蛋白(清爽原味)」此產品。  
嚴格遵守以下規範，僅回傳最終 JSON 結果，**不做其他敘述**。

1. 分析規則  
   - 只偵測「豐力富即溶濃縮乳清蛋白(清爽原味)」，忽略其他品牌與包裝。  
...
# 測試圖片資料夾 & 標籤資料夾
TEST_FOLDER = "/Users/y/Documents/Programming/大四上/價格辨識/中文辨識/新品/豐力富乳清蛋白粉"
